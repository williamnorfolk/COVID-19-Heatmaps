...
```{r}
ga_only <- subset(covid_3_23, Province_State == "Georgia")
...
```{r}
#Match up names
ga_fix_vars <- ga_pull_vars %>% rename(ga_cases_3_23 = Confirmed, ga_deaths_3_23 = Deaths, ga_recov_3_23 = Recovered, ga_active_3_23 = Active, fips = FIPS)
```
...
#saveRDS(ga_fix_vars, file = "../ga_only_clean_data.rds")
```
