...
extp_1 <- subset(only_8_and_11, Province_State == "California")
extp_2 <- subset(only_8_and_11, Province_State == "Mississippi")
extp_3 <- subset(only_8_and_11, Province_State == "Texas")
extp_4 <- subset(only_8_and_11, Province_State == "Alabama")
extp_5 <- subset(only_8_and_11, Province_State == "North Carolina")
extp_6 <- subset(only_8_and_11, Province_State == "Oregon")
extp_7 <- subset(only_8_and_11, Province_State == "Alaska")
