...
extp_1 <- subset(only_6_and_9, Province_State == "California")
extp_2 <- subset(only_6_and_9, Province_State == "Alaska")
extp_3 <- subset(only_6_and_9, Province_State == "Oregon")
extp_4 <- subset(only_6_and_9, Province_State == "Alabama")
extp_5 <- subset(only_6_and_9, Province_State == "Utah")
extp_6 <- subset(only_6_and_9, Province_State == "North Carolina")
extp_7 <- subset(only_6_and_9, Province_State == "South Carolina")
extp_8 <- subset(only_6_and_9, Province_State == "Michigan")
extp_9 <- subset(only_6_and_9, Province_State == "Arkansas")
extp_10 <- subset(only_6_and_9, Province_State == "Arizona")
