...
extp_1 <- subset(only_5_and_8, Province_State == "Texas")
extp_2 <- subset(only_5_and_8, Province_State == "California")
extp_3 <- subset(only_5_and_8, Province_State == "New Mexico")
extp_4 <- subset(only_5_and_8, Province_State == "Alabama")
extp_5 <- subset(only_5_and_8, Province_State == "Michigan")
extp_6 <- subset(only_5_and_8, Province_State == "North Carolina")
extp_7 <- subset(only_5_and_8, Province_State == "Utah")
extp_8 <- subset(only_5_and_8, Province_State == "Arkansas")
extp_9 <- subset(only_5_and_8, Province_State == "South Carolina")
