...
extp_1 <- subset(only_7_and_10, Province_State == "Mississippi")
extp_2 <- subset(only_7_and_10, Province_State == "Utah")
extp_3 <- subset(only_7_and_10, Province_State == "Alabama")
extp_4 <- subset(only_7_and_10, Province_State == "Alaska")
extp_5 <- subset(only_7_and_10, Province_State == "North Carolina")
extp_6 <- subset(only_7_and_10, Province_State == "Oregon")
extp_7 <- subset(only_7_and_10, Province_State == "Arkansas")
extp_8 <- subset(only_7_and_10, Province_State == "Michigan")
extp_9 <- subset(only_7_and_10, Province_State == "Arizona")
extp_10 <- subset(only_7_and_10, Province_State == "South Carolina")
