...
extp_1 <- subset(only_4_and_7, Province_State == "Idaho")
extp_2 <- subset(only_4_and_7, Province_State == "California")
extp_3 <- subset(only_4_and_7, Province_State == "New Mexico")
extp_4 <- subset(only_4_and_7, Province_State == "Texas")
extp_5 <- subset(only_4_and_7, Province_State == "South Carolina")
extp_6 <- subset(only_4_and_7, Province_State == "Kentucky")
extp_7 <- subset(only_4_and_7, Province_State == "North Carolina")
extp_8 <- subset(only_4_and_7, Province_State == "Utah")
extp_9 <- subset(only_4_and_7, Province_State == "Arkansas")
